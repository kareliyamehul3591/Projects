                ...
                <div className="therapy_box bg-pink">
                    <div className="top" id="headingOne">
                        ...
                        <div className="row">
                            ...
                            <div className="col-auto">
                                <a href="#" id={'hide_session_'+item.user_id} onClick={() => fetchData(item.user_id)} className="btn gradient-btn collapsed hide_session" data-toggle="collapse" data-target={"#collapseOne"+ item.user_id} aria-expanded="true" aria-controls="collapseOne">Book A Session</a>
                                <a  href='/login'  id={'hide_book_'+item.user_id} style={{display: 'none'}} className="btn gradient-btn booking">Book</a>
                            </div>
                    ...
                    <div id={"collapseOne" + item.user_id}  className="collapse session-book-box" aria-labelledby="headingOne" data-parent="#accordionExample">
                        ...
                        {time.map((session,i) =>{
                            ...
                            if(item.user_id === time.therapist_id){
                             ...
                             return <a id={"myDIV_"+time.therapist_id+"_"+i } className="time-period" onClick={() => hidesession(i,session,time.therapist_id)} ><span>{session}</span></a>
