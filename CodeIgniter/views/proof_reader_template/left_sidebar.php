    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php echo $this->session->Admindetail['name']; ?> ( ProofReader ) </p>
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="<?php if($left_sidebar == 'Proof Reader Dashboard'){ echo 'active';}?>" >
			<a href="<?php echo base_url(); ?>index.php/Proof_reader_dashboard">
				<i class="fa fa-dashboard"></i> <span>Dashboard</span>
			</a>
		</li>
		<li class="<?php if($left_sidebar == 'Proof Reader Profile'){ echo 'active';}?>" >
			<a href="<?php echo base_url(); ?>index.php/Proof_reader_profile">
				<i class="fa fa-user"></i> <span>Profile</span>
			</a>
		</li>
		<li class="<?php if($left_sidebar == 'Proof Reader Message'){ echo 'active';}?>" >
			<a href="<?php echo base_url(); ?>index.php/Proof_reader_message">
		...
		<li class="<?php if($left_sidebar == 'Proof Reader Search'){ echo 'active';}?>" >
			<a href="<?php echo base_url(); ?>index.php/Proof_reader_search">
