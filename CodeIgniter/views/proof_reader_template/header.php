...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url(); ?>index.php/Proof_reader_dashboard" class="logo">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
			...
			<li class="dropdown messages-menu" style="padding-top: 13px;" >
				<form method="post" class="login-form" action="<?php echo base_url(); ?>index.php/Proof_reader_search" enctype="multipart/form-data">
					<ul class="nav navbar-nav">
		...
		<li class="dropdown messages-menu header_messages">
			...
			<li class="footer"><a href="<?php echo base_url(); ?>index.php/Proof_reader_message">See All Messages</a></li>
			</ul>
		</li>
		...
		<script>
			...
			function header_message() {
				setTimeout(function () {	
					...
					$.ajax({
						url: '<?php echo base_url(); ?>index.php/Proof_reader_message/header_message_get/',
						type: "POST",
						data : ({ to_role: "Proof Reader",count: messages_count }),
						dataType: "json",
		...
		<li class="dropdown messages-menu header_notifications ">
			...
			<ul class="dropdown-menu" style="width: 666px;" >
				...
				<li class="footer"><a href="<?php echo base_url(); ?>index.php/Proof_reader_notifications">View all</a></li>
			</ul>
		</li>
		...
		<script>
			...
			function header_notifications() {
				setTimeout(function () {	
					...
					$.ajax({
						url: '<?php echo base_url(); ?>index.php/Proof_reader_message/header_notifications_get/',
						type: "POST",
						data : ({ count: count }),
						dataType: "json",
						success: function (data) {
		  ...
		  <li class="dropdown messages-menu">
				...
				<ul class="dropdown-menu" role="menu" style="width: 0px;" >
					<li><a href="<?php echo base_url(); ?>index.php/Help?tab=basic&role=proofreader">Basic Guidelines</a></li>
					<li><a href="<?php echo base_url(); ?>index.php/Help?tab=samples&role=proofreader">Samples</a></li>
					<?php if($main_content != 'help'){ ?>
					<li><a href="<?php echo base_url(); ?>index.php/Help?tab=help&role=proofreader&page=<?php echo $main_content; ?>">Help Withe This Page</a></li>
					<?php } ?>
					<li class="divider"></li>
					<li><a href="<?php echo base_url(); ?>index.php/Help/contact?role=proofreader">Contact Us</a></li>
				</ul>
			</li>
		   <?php if($left_sidebar != 'Proof Reader Message'){?>
          <li>
