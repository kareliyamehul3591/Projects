    ...
    <div class="tab-content">
      <div class="tab-pane active">
        <ul class="control-sidebar-menu">
			...
			<?php 
			$all_messages = $this->Mdl_common->all_message('Admin');
			$all_messages_me = $this->Mdl_common->all_message_me('Admin');
			$user = array();
