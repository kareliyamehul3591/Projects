...
<div class="wrapper">
  ...
  <header class="main-header">
	...
	{
		$.ajax({
			url: '<?php echo base_url(); ?>index.php/Manager_dashboard/dashboards/',
			success: function (data) {
				window.location = "<?php echo base_url(); ?>index.php/Manager_dashboard/";
			}
		});	
	}
	</script>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
		...
		<li class="dropdown messages-menu header_messages">
			...
			<li class="footer"><a href="<?php echo base_url(); ?>index.php/Manager_message">See All Messages</a></li>
			</ul>
		</li>
		...
		<script>
			...
			function header_message() {
				setTimeout(function () {
					...
					$.ajax({
						url: '<?php echo base_url(); ?>index.php/Manager_message/header_message_get/',
						type: "POST",
						data : ({ to_role: "Manager",count: messages_count }),
						dataType: "json",
						success: function (data) {
							if(data.status == 1)
							{
		...
		<li class="dropdown messages-menu header_notifications ">
			...
			<ul class="dropdown-menu" style="width: 666px;">
				...
				<li class="footer"><a href="<?php echo base_url(); ?>index.php/Manager_notifications">View all</a></li>
			</ul>
		</li>
		...
		<script>
			...
			function header_notifications() {
				setTimeout(function () {	
					...
					$.ajax({
						url: '<?php echo base_url(); ?>index.php/Manager_message/header_notifications_get/',
						type: "POST",
						data : ({ count: count }),
						dataType: "json",
						success: function (data) {
		  ...
		  <li class="dropdown messages-menu">
				...
				<ul class="dropdown-menu" role="menu" style="width: 0px;" >
					<li><a href="<?php echo base_url(); ?>index.php/Help?tab=basic&role=manager">Basic Guidelines</a></li>
					<li><a href="<?php echo base_url(); ?>index.php/Help?tab=samples&role=manager">Samples</a></li>
					<?php if($main_content != 'help'){ ?>
					<li><a href="<?php echo base_url(); ?>index.php/Help?tab=help&role=manager&page=<?php echo $main_content; ?>">Help Withe This Page</a></li>
					<?php } ?>
					<li class="divider"></li>
					<li><a href="<?php echo base_url(); ?>index.php/Help/contact?role=manager">Contact Us</a></li>
				</ul>
			</li>
			
		  <?php if($left_sidebar != 'Manager Message'){?>
          <li>
