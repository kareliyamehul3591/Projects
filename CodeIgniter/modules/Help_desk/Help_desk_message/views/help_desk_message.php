  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
			...
			<div class="box box-default">
				...
				<div class="box-footer no-padding">
					<ul class="products-list product-list-in-box" style="overflow: scroll;height: 695px;" >
						<?php 
							$all_messages = $this->Mdl_common->all_message('Help Desk');
							$all_messages_me = $this->Mdl_common->all_message_me('Help Desk');
							$user = array();
							...
							foreach($user as $data)
							{
								...
								if($to_id[0]['status'] == 1)
								{
									...
									$c = 0;
									$messages = $this->Mdl_help_desk_message->message($to_id[0]['id'],$data['to_role'],'Help Desk',$data['assignment_id']);
									...
									$proof_reader_url = base_url()."index.php/Help_desk_message?id=".$to_id[0]['id']."&role=".$data['to_role']."&assignment_id=".$data['assignment_id'];
									echo '<li class="item">
        ...
        <div class="col-md-9">
		<?php if($_GET['id'] != null){ 
		$ids = $this->Mdl_help_desk_message->user_id($_GET['id']);
		?>
		  <div class="box box-primary direct-chat direct-chat-primary">
                ...
                <div class="box-body">
				  ...
				  <?php
				  $message = $this->Mdl_help_desk_message->message($_GET['id'],$_GET['role'],'Help Desk',$_GET['assignment_id']);
				  foreach($message as $messag){
					  
					  $user_id = $this->Mdl_help_desk_message->user_id($messag['from_id']);
