  ...
  <div class="content-wrapper">
    ...
    <section class="content">
		...
		<div class="box box-info">
            ...
            <div class="box-body">
				<?php $data = $datas[0]; ?>
				<form method="post" class="login-form" action="<?php echo base_url(); ?>index.php/Help_desk_dashboard/assignment_edit" id="assignment_add" enctype="multipart/form-data" >
