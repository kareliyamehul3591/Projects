  ...
  <div class="content-wrapper">
    ...
    <section class="content">
		<div class="box box-info">
            ...
            <div class="box-body">
				<form method="post" class="login-form" action="<?php echo base_url(); ?>index.php/Help_desk_dashboard/assignment_add" id="assignment_add" enctype="multipart/form-data" >
					<div class="row">
						<?php 
						$assignments = $this->Mdl_help_desk_dashboard->assignments($_POST['id']);
						$data = $assignments[0]
						?>
						<input type="hidden" name="idss" id="idss"  value="<?php echo $_POST['id']; ?>">
						...
						<div class="col-xs-6">
							<?php $clients = $this->Mdl_help_desk_dashboard->dropdowns('client'); ?>
					...
					<div class="row">
						...
						<div class="col-xs-6">
							<?php $types = $this->Mdl_help_desk_dashboard->dropdowns('dropdowns_type'); ?>
					...
					<div class="row">
						...
						<div class="col-xs-6">
							<?php $niches = $this->Mdl_help_desk_dashboard->dropdowns('dropdowns_niche'); ?>
