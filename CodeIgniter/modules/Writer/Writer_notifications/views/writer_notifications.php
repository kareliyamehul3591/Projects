				...
				<div class="box box-info">
					...
					<div class="box-body">
						<table class="table table-bordered table-striped datatable_asc">
							...
							<tbody>
							<?php foreach($writer_notifications as $key => $data) { 
							$key++;
							$from_id = $this->Mdl_writer_notifications->user_name($data['from_id']);
							$to_id = $this->Mdl_writer_notifications->user_name($data['to_id']);
							$assignment_id = $this->Mdl_writer_notifications->assignment($data['assignment_id']);
							$writer_id = $this->Mdl_writer_notifications->assign_to_ma_id($data['assignment_id']);
							?>
								<tr>
									<td> <?php echo $key; ?> </td>
									...
									<td> 
										...
										if($writer_id != null && $writer_id[0]['status'] != 2){ ?>
											<a href="<?php echo base_url(); ?>index.php/Writer_dashboard/assignment_view/<?php echo $data['assignment_id']; ?>" style="color: #13c5ff;" ><i class="fa fa-eye fa-lg"></i></a>
											<a href="<?php echo base_url(); ?>index.php/Writer_message" style="color: #2c893a;"><i class="fa fa-commenting fa-lg"></i></a>
											<?php
