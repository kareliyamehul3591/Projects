  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
						...
						<?php 
							...
							foreach($user as $data)
							{
								...
								if($to_id[0]['status'] == 1)
								{
									...
									$c = 0;
									$messages = $this->Mdl_writer_message->message($to_id[0]['id'],$data['to_role'],'Writer',$data['assignment_id']);
									...
									$proof_reader_url = base_url()."index.php/Writer_message?id=".$to_id[0]['id']."&role=".$data['to_role']."&assignment_id=".$data['assignment_id'];
									echo '<li class="item">
        ...
        <div class="col-md-9">
		<?php if($_GET['id'] != null){
			$ids = $this->Mdl_writer_message->user_id($_GET['id']);
			?>
		  <div class="box box-primary direct-chat direct-chat-primary">
                ...
                <div class="box-body">
				  ...
				  <?php
				  $message = $this->Mdl_writer_message->message($_GET['id'],$_GET['role'],'Writer',$_GET['assignment_id']);
				...
				<div class="box-footer">
					<!--<form method="post" action="<?php echo base_url(); ?>index.php/Writer_message/message_add" >-->
