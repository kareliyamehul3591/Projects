                    ...
                    <div class="box-body">
                        <form method="post" class="login-form" action="<?php echo base_url(); ?>index.php/Writer_dashboard/assignment_image_add" id="assignment_add" enctype="multipart/form-data">
						   ...
						   <div class="row">
                                ...
                                <?php $writer_ids = $this->Mdl_writer_dashboard->writer_id($datas[0]['id']); ?>
								...
								<?php if($writer_ids[0]['status'] == 1){ ?>
									...
									<div class="col-xs-6">
										<?php
											...
											if($writer_ids[0]['writer_id'] == $this->session->Admindetail['id'] && $writer_ids[0]['status'] == 1)
											{
												...
												{ 
													if($file != NULL)
													{
														$key++;
														echo $key." :- ";
														echo '<a href="'.base_url().'uploads/Assignment/'.$datas[0]['id'].'/writer/'.$file.'" target="_blank" >'.$file.'</a>';
														if($datas[0]['status'] != 5){
							...
							<?php 
							$writer_id = $this->Mdl_writer_dashboard->writer_id($datas[0]['id']);
							if($writer_id[0]['status'] == 5 || $datas[0]['status'] == 4 || $writer_id[0]['status'] == 2 || $datas[0]['status'] == 7)
							{ ?>
							...
							{
								$accept_url = "myModal('".base_url()."index.php/Writer_dashboard/accept_taske/".$datas[0]['id']."')";
								$reject_url = "myModal('".base_url()."index.php/Writer_dashboard/reject_taske/".$datas[0]['id']."')";
							?>
								<div class="box-footer">
							...
							<div class="modal-content">
							  ...
							  <div class="modal-footer">
								<button type="button" class="btn btn-default pull-left" data-dismiss="modal">Do not leave</button>
									<?php if($writer_id[0]['status'] == 5 || $datas[0]['status'] == 4){?>
										<a href="<?php echo base_url(); ?>index.php/Writer_dashboard/show_archived" type="button" class="btn btn-primary">Leave Page</a>
									<?php }else{ ?>
										<a href="<?php echo base_url(); ?>index.php/Writer_dashboard" type="button" class="btn btn-primary">Leave Page</a>
									<?php } ?>
							  </div>
							</div>
						  </div>
