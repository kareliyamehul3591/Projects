...
const authService = new AuthService( new Auth().getInstance(), new User().getInstance(), new Account().getInstance() );
...
class AuthController {
    ...
    async updateProfile( req, res, next ) {
        try{
            const id = req.user._id;
            await this.service.updateProfile( id, new this.userDTO.UpdateDTO( req.body ) );
            res.sendCalmResponse( null, { 'updated': true } );
